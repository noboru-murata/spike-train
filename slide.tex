...
\label{sec:orgb7ae532}
\begin{frame}[label={sec:org8062fec}]{Background}
\begin{itemize}
...
\begin{frame}[label={sec:orgd9f5bca}]{Multi-Electrode Recording}
\begin{columns}
...
\begin{frame}[label={sec:orgf263d36}]{Spike Trains}
\begin{columns}
...
\begin{frame}[label={sec:org55cc439}]{Graph Structure Inference}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgc403892}]{Prior Works}
...
\begin{frame}[label={sec:org812607d}]{Issues to Be Solved}
\begin{itemize}
\item pseudo correlation caused by higher-order effects
\item influence from unobserved neurons
\item directed excitatory/inhibitory connections
\end{itemize}
\end{frame}

\begin{frame}[label={sec:org3be6ebe}]{Pseudo Correlation}
...
\begin{frame}[label={sec:orgeb8926b}]{Delayed Pseudo-Correlation}
...
\begin{frame}[label={sec:orge33b33b}]{Our Contribution}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7f10472}]{Internal State}
...
\begin{frame}[label={sec:org7f3c8e2}]{Neuron Firing}
...
\begin{frame}[label={sec:org486cb66}]{Model Description}
\begin{itemize}
\item internal state
\begin{align}
  &U_i(t)
...
\begin{frame}[label={sec:orgce53efc}]{Conditinal Expectation of State}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org3a30f47}]{Conditional Expectation of Internal State}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org85c50b8}]{Difference of Conditional Expectation}
\begin{itemize}
...
\begin{frame}[label={sec:orga65f052}]{Estimation of Pseudo Connection}
\begin{itemize}
...
\begin{frame}[label={sec:org383b576}]{Decomposition of Pseudo Connection}
...
\begin{frame}[label={sec:org5b5decc}]{Decomposition}
\begin{itemize}
...
\begin{frame}[label={sec:orga389579}]{Estimation of Virtual Probability}
\begin{itemize}
...
\begin{frame}[label={sec:org2f38f68}]{Estimation of Neuron Type}
...
\begin{frame}[label={sec:orgfd72b95}]{Proposed Algorithm}
\small
\begin{algorithmic}[1]
...
\label{sec:org0ddb6a7}
\subsection{synthetic data analysis}
\label{sec:orgd966e0c}
\begin{frame}[label={sec:orge3ab8a5}]{Synthetic Data Analysis}
\begin{columns}
\begin{column}{0.5\columnwidth}
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org46daef2}]{Estimation Result}
\begin{columns}
\begin{column}{0.5\columnwidth}
\centering
true\\[0pt]
...
\begin{frame}[label={sec:org6ee7d8e}]{Estimation Result}
\begin{columns}
...
\section{Conclusion}
\label{sec:orgefff9a0}
\begin{frame}[label={sec:orgddb03ec}]{Concluding Remarks}
