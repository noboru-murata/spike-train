...
\label{sec:org546c1d2}
\begin{frame}[label={sec:org5b90ce3}]{Background}
\begin{itemize}
...
\begin{frame}[label={sec:org9359687}]{Graph Structure Inference}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org9f71fc4}]{Prior Works}
...
\begin{frame}[label={sec:orgb4ef165}]{Issues to Be Solved}
\begin{itemize}
...
\begin{frame}[label={sec:org920f6f8}]{Pseudo Correlation}
...
\begin{frame}[label={sec:orgdda945e}]{Delayed Pseudo-Correlation}
...
\begin{frame}[label={sec:org6787a56}]{Our Contribution}
...
\begin{frame}[label={sec:org22cd685}]{}
\footnotesize
...
\item excitatory:inhibitory = 80$\backslash$%:20$\backslash$%
...
\begin{frame}[label={sec:orge104712}]{Estimation Result}
\begin{columns}
...
\section{Conclusion}
\label{sec:org2d899cb}
\begin{frame}[label={sec:orgcc8d5a3}]{Concluding Remarks}
