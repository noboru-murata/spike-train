...
\label{sec:org2424534}
\begin{frame}[label={sec:orgb774e41}]{Background}
\begin{itemize}
...
\begin{frame}[label={sec:orgcb004dd}]{Graph Structure Inference}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbaeab31}]{Prior Works}
...
\begin{frame}[label={sec:org70a887d}]{Issues to Be Solved}
\begin{itemize}
...
\begin{frame}[label={sec:org04bccce}]{Pseudo Correlation}
...
\begin{frame}[label={sec:org9fdea08}]{Delayed Pseudo-Correlation}
...
\begin{frame}[label={sec:org1673bf2}]{Our Contribution}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org578448c}]{Internal State}
...
\begin{frame}[label={sec:org44a8426}]{Neuron Firing}
...
\begin{frame}[label={sec:orgc733c14}]{Model Description}
\begin{itemize}
\item internal state
\begin{align}
  &U_i(t)
...
\begin{frame}[label={sec:orgbe42262}]{Conditinal Expectation of State}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org3ace738}]{Conditional Expectation of Internal State}
\begin{itemize}[<+->]
...
\begin{frame}[label={sec:org073d524}]{Difference of Conditional Expectation}
\begin{itemize}
...
\begin{frame}[label={sec:org9dcbabc}]{Estimation of Pseudo Connection}
\begin{itemize}
...
\begin{frame}[label={sec:org3d4cb23}]{Decomposition of Pseudo Connection}
...
\begin{frame}[label={sec:org734c017}]{Decomposition}
\begin{itemize}
...
\begin{frame}[label={sec:org4c93b18}]{Estimation of Virtual Probability}
\begin{itemize}
...
\begin{frame}[label={sec:org7dad67f}]{Estimation of Neuron Type}
...
\begin{frame}[label={sec:org491369d}]{Proposed Algorithm}
\small
\begin{algorithmic}[1]
...
\label{sec:org6d55f44}
\subsection{synthetic data analysis}
\label{sec:org877c9fc}
\begin{frame}[label={sec:org5a20241}]{Synthetic Data Analysis}
\begin{columns}
\begin{column}{0.5\columnwidth}
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7976ed3}]{Estimation Result}
\begin{columns}
\begin{column}{0.5\columnwidth}
\centering
true\\[0pt]
...
\begin{frame}[label={sec:orgce21946}]{Estimation Result}
\begin{columns}
...
\section{Conclusion}
\label{sec:orgac72184}
\begin{frame}[label={sec:orgcc03b7e}]{Concluding Remarks}
